...
<div class="body flex-grow-1 px-3">
    <div class="container-xxl">
        ...
        <div class="row">
            ...
            <div class="row">
                @include('templates.select-floating-fun',['vColumnas'=>4,'vLabel'=>'Código de la Campaña','vNombre'=>'cd_remesa','vStyle'=>'display:block;','vOptions'=>$vOptionsRemesas,'vFuncion'=>'fnBuscarCampaniasPorProceso()'])
