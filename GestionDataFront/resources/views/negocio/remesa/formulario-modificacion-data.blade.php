                ...
                <div style="font-size:14px;padding-left:10px;" class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" style="padding-top:10px;">
                            <button class="btn btn-dark px-4" onclick="fnBuscarClienteModificacionData()">
                                Buscar Cliente
                            </button>
                        </div>
        		...
        		<form onsubmit="return false;" name="forms-errores-emision" >
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12"> 
                                <center>
                                <br> <button class="btn btn-info btn-sm col-md-3" onclick="fnProcesarModificacionData()" style="font-size: 14px;color:white;font-weight: bolder;">Cargar</button>
                                </center>
                            </div>
                        </div>
                    </div>
